...
Info
    Defines GenPicomCommandExecutor class.
'''
...
class GenPicomCommandExecutor:
    '''
        Command executor strategy for generating picom configuration files.
        ...
        It defines:
            ...
            :methods:
                ...
                | __str__ - Returns the GenPicomCommandExecutor as string representation.
    '''
    ...
    def __str__(self) -> str:
        '''
            Returns the GenPicomCommandExecutor as string representation.

            :return: The GenPicomCommandExecutor as string representation.
        '''
        return to_str(self)
