...
from armpicom.infrastructure.cli.setup.options import CLIBundleOptions
from armpicom.infrastructure.cli.setup.opt_validator import CLIBundleOptionsValidator
from armpicom.infrastructure.cli.setup.bundle import CLIBundle
from armpicom.infrastructure.cli.setup.keys import CLIBundleKeys
...
class CLIBundleFactory:
    ...
    def create_bundle(cls, options: CLIBundleOptions) -> CLIBundle:
        ...
        service_definition: ICommandDefinition = GenPicomCommandDefinition()
        service_executor: ICommandExecutor = GenPicomCommandExecutor(definition=service_definition)
