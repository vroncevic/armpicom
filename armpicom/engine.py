...
class ARMPicom(Base):
    '''
        ...
        It defines:
            ...
            :attributes:
                | _is_initialized - The flag indicating whether the armpicom engine is initialized.
            ...
            :methods:
                ...
                | process - Processes the armpicom commands.
    '''
    ...
    def __init__(self, bundle: ARMPicomBundle) -> None:
        '''
