...
Info
    A validator for the armpicom bundle.
'''
...
class ARMPicomBundleValidator:
    '''
        ...
        It defines:
            ...
            :methods:
                | validate - Validates the armpicom bundle.
                | is_valid - Checks if the armpicom bundle is valid.
    '''

    @classmethod
    def validate(cls, bundle: ARMPicomBundle) -> None:
        '''
            Validates the armpicom bundle.

            :param bundle: The armpicom bundle to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'armpicom_bundle_validator::validate(...)'
        msg_bundle_none: str = 'the armpicom bundle must be provided'
        msg_bundle_istype: str = 'the armpicom bundle must be an instance of ARMPicomBundle'
        ...
        istype(bundle, ARMPicomBundle, ctx, msg_bundle_istype)
    ...
    @classmethod
    def is_valid(cls, bundle: ARMPicomBundle) -> bool:
        '''
            Checks if the armpicom bundle is valid.

            :param bundle: The armpicom bundle to be checked.
