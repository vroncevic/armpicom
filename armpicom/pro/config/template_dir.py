...
Info
    ...
    Creates an API for template directory for generation.
'''
...
class TemplateDir:
    ...
    _GEN_VERBOSE = 'ARMPICOM::PRO::CONFIG::TEMPLATE_DIR'
    ...
    def __init__(self, verbose: bool = False) -> None:
        ...
        verbose_message(verbose, [f'{self._GEN_VERBOSE} init template dir'])
    ...
    def is_template_dir_ok(self) -> bool:
        ...
        '''
        return all([
            self._template_dir is not None, isinstance(self._template_dir, str)
        ])
